...
let dernier = genererNombreEntier(6);
let nombreAleatoire;

const citation = document.getElementById("citation");
const auteur = document.getElementById("auteur");
const button = document.getElementById("nouveau");
...
function integerQuote(quote) {
  citation.innerHTML = citations[quote][0];
}

function integerAuthor(author) {
  auteur.innerHTML = citations[author][1];
}
...
function newQuote() {
  ...
  integerQuote(dernier);
  integerAuthor(dernier);
}
